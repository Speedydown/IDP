...
class Leg(object):
    ...
    def __init__(self, AddressArray, ChannelArray, DefaultPulseArray, inverse = False):
    ...
    # it will print an Error.
        if len(self._AddressArray) == 3:
            self._Hip = Servo(self._AddressArray[0], self._ChannelArray[0], self._DefaultPulseArray[0], self._inverse)
            self._Knee = Servo(self._AddressArray[1], self._ChannelArray[1], self._DefaultPulseArray[1], self._inverse)
            self._Ankle = Servo(self._AddressArray[2], self._ChannelArray[2],self._DefaultPulseArray[2], self._inverse)
        else:
